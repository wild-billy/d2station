...
About Recipes:
	...
	They also have a proc that is called when the recipe is matched.
		...
		required_stabilizers (Added February 2012)
			This is a list of the ids of the required stabilizers.
			Much like catalysts, they are not consumed in the reaction, yet if they're not
			in the holder during it they cause the brew to explode spectacularly.
