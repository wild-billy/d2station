...
/obj/machinery/light
	...
	var/on_gs = 0
	var/brightness = 24			// luminosity when on, also used in power calculation
...
// satellite beacons
/obj/machinery/light/floorbeaconred
	icon_state = "floorbeaconred0"
	base_state = "floorbeaconred"
	fitting = "bulb"
	brightness = 1
	desc = "A large light fixture that helps indicate a large structure."
	light_type = /obj/item/weapon/light/bulb

/obj/machinery/light/floorbeaconblue
	icon_state = "floorbeaconblue0"
	base_state = "floorbeaconblue"
	fitting = "bulb"
	brightness = 1
	desc = "A large light fixture that helps indicate a large structure."
	light_type = /obj/item/weapon/light/bulb
...
/obj/machinery/light/proc/update()
	...
	if(status == LIGHT_BROKEN)
		if(prob(5))
			new /obj/effects/sparks(src.loc)
	...
	//ul_SetLuminosity(on * brightness)		// *DAL*
	ul_SetLuminosity(on * brightness)
						...
						if(R.fields["name"] == perpname)
							for (var/datum/data/record/S in data_core.security)
								if (S.fields["id"] == R.fields["id"])
									...
									S.fields["mi_crim"] = "Vandalism (Breaking Lights)"
									break
...
#define LIGHTING_POWER_FACTOR 10		//10W per unit luminosity
...
/obj/machinery/light/lamp/attack_hand(mob/user)
	...
	if(user.a_intent == "grab")
		...
		switchon = !switchon
		user << "You switch [switchon ? "on" : "off"] \the [name]."
...
/obj/item/weapon/light/tube
	...
	desc = "A replacement fluorescent lamp."
	icon_state = "ltube"
	base_state = "ltube"
	item_state = "c_tube"
	g_amt = 200
