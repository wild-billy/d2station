/mob/living/carbon/human/say(var/message)
	...
	/*if(prob(50))
		...
		if(findtext("AI",message) || findtext("A.I.",message) || prob(3))
			...
			for (var/mob/living/silicon/ai/M in world)
				...
				if (!M.client)
					world << "clientless ai"
					var/aibot = world.Export("http://vps.d2k5.com/markov/?input=[message] [name] [M.name]")
					world << "trying http://vps.d2k5.com/markov/?input=[message] [name] [M.name]"
					if(aibot)
						world << aibot
	...
	/*if(istype(src:head, /obj/item/clothing/head/helmet/space))
		var/ttscontent = world.Export("http://178.63.153.81/ss13/tts/request.php?speech=[message]&volume_scale=1&save_mp3=1&make_audio=Text-To-Speech")
		if(ttscontent)
