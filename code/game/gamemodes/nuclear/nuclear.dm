...
/datum/game_mode/nuclear/post_setup()
	...
	for (var/obj/landmark/A in landmarkz)
...
/datum/game_mode/proc/equip_syndicate(mob/living/carbon/human/synd_mob)
	...
	synd_mob.equip_if_possible(new /obj/item/clothing/under/nazi(synd_mob), synd_mob.slot_w_uniform)
	synd_mob.equip_if_possible(new /obj/item/clothing/shoes/jackboots(synd_mob), synd_mob.slot_shoes)
	synd_mob.equip_if_possible(new /obj/item/clothing/suit/nazicoat(synd_mob), synd_mob.slot_wear_suit)
...
/datum/game_mode/nuclear/declare_completion()
	var/disk_rescued = 1
	for(var/obj/item/weapon/disk/nuclear/D in mobz)
...
/proc/nukelastname(var/mob/M as mob) //--All praise goes to NEO|Phyte, all blame goes to DH, and it was Cindi-Kate's idea. Also praise Urist for copypasta ho.
	...
	var/newname = strip_html(input(M,"You are the nuke operative [pick("Czar", "Boss", "Commander", "Chief", "Kingpin", "Director", "Overlord")]. Please choose a last name for your family.", "Name change",randomname))
