/var/const
	...
	access_change_ids_RD = 60
	access_change_ids_Medical = 61
	access_change_ids_Engineering = 62
	access_change_ids_Security = 63
	access_Security_check = 64
...
/proc/get_access(job)
	switch(job)
		...
		if("Detective")
			return list(access_Security_check, access_security, access_forensics_lockers, access_morgue, access_maint_tunnels, access_court)
		if("Medical Doctor")
			return list(access_medical, access_morgue, access_surgery, access_robotics, access_medlab)
		if("Botanist")	// -- TLE
			return list(access_hydroponics, access_maint_tunnels) // Removed tox and chem access because STOP PISSING OFF THE CHEMIST GUYS // //Removed medical access because WHAT THE FUCK YOU AREN'T A DOCTOR YOU GROW WHEAT
	//	if("Librarian") // -- TLE
...
//			return list(access_Security_check, access_security, access_brig, access_court, access_maint_tunnels)

		if("Security Officer")
			return list(access_Security_check, access_security, access_brig, access_court, access_maint_tunnels)
		if("Warden")
			return list(access_Security_check, access_security, access_brig, access_armory, access_court)
		if("Scientist")
			return list(access_tox, access_tox_storage, access_research, access_xenobiology)

		if("Head of Security")
			return list(access_Security_check, access_change_ids_Security, access_medical, access_morgue, access_tox, access_tox_storage, access_chemistry, access_medlab, access_court,
		...
		if("Head of Personnel")
			return list(access_Security_check, access_change_ids_Engineering, access_change_ids_Security, access_change_ids_Medical, access_security, access_brig, access_court, access_forensics_lockers,
			            access_medical, access_engine,
			            ...
			            access_crematorium, access_kitchen, access_robotics, access_cargo, access_cargo_bot, access_hydroponics,
			           	access_research, access_mining, access_heads_vault,
			            access_hop, access_RC_announce, access_change_ids_RD)
		...
		if("Roboticist")
			return list(access_surgery, access_robotics, access_tech_storage, access_maint_tunnels, access_medical)
		if("Cargo Technician")
		...
		if("Chief Engineer")
			return list(access_Security_check, access_change_ids_Engineering, access_engine, access_engine_equip, access_tech_storage, access_maint_tunnels,
		...
		if("Research Director") // removed hydroponics access, they are a supply field, not science
			return list(access_Security_check, access_change_ids_RD, access_rd, access_tech_storage, access_maint_tunnels, access_heads, access_tox,
		...
		if("Virologist")
			return list(access_morgue, access_virology, access_research, access_medical)
		if("Chief Medical Officer")
			return list(access_maint_tunnels, access_Security_check, access_change_ids_Medical, access_medical, access_morgue, access_medlab, access_heads,
			access_chemistry, access_cmo, access_surgery, access_robotics, access_RC_announce)
		else
			return list()
...
/proc/get_all_accesses()
	return list(access_Security_check, access_change_ids_Engineering, access_change_ids_Medical, access_change_ids_Security, access_change_ids_RD, access_security, access_brig, access_armory, access_forensics_lockers, access_court,
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(access_Security_check)
			return "Command Area - Security Check Point"
...
/proc/get_all_jobs()
	return list("Assistant", "Station Engineer", "Shaft Miner", "Detective", "Medical Doctor", "Captain", "Security Officer", "Warden",
				"Geneticist", "Scientist", "Schutzstaffel Officer", "Head of Security", "Head of Personnel", "Atmospheric Technician",
...
/proc/get_all_accessesRD()
	return list(access_Security_check, access_rd, access_change_ids_RD, access_tech_storage, access_maint_tunnels, access_heads, access_tox,
			            access_tox_storage, access_chemistry, access_teleporter, access_virology,
			            access_research, access_robotics, access_xenobiology, access_RC_announce)
/proc/get_all_accesses_Medical()
	return list(access_Security_check, access_medical, access_morgue, access_medlab, access_heads,
			access_chemistry, access_cmo, access_surgery, access_robotics, access_RC_announce)

/proc/get_all_accesses_Sec()
			return list(access_Security_check, access_change_ids_Security, access_medical, access_morgue, access_tox, access_tox_storage, access_chemistry, access_medlab, access_court,
			            access_teleporter, access_heads, access_tech_storage, access_security, access_brig, access_atmospherics,
			            access_maint_tunnels, access_bar, access_janitor, access_kitchen, access_robotics, access_armory, access_hydroponics,
			            access_research, access_hos, access_RC_announce)
/proc/get_all_accesses_Eng()
			return list(access_Security_check, access_janitor, access_change_ids_Engineering, access_engine, access_engine_equip, access_tech_storage, access_maint_tunnels,
			            access_external_airlocks, access_atmospherics, access_emergency_storage, access_eva,
			            access_heads, access_ai_upload, access_construction, access_robotics,
			            access_mint, access_ce, access_RC_announce)
/proc/get_all_jobsRD()
	return list("Scientist", "Research Director", "Botanist", "Virologist")

/proc/get_all_jobsMedical()
