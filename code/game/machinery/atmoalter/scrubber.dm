...
/obj/machinery/portable_atmospherics/scrubber/attack_hand(var/mob/user as mob)
	...
	if(holding)
		holding_text = {"<link rel='stylesheet' href='http://178.63.153.81/ss13/ui.css' /><BR><B>Tank Pressure</B>: [holding.air_contents.return_pressure()] KPa<BR>
<A href='?src=\ref[src];remove_tank=1'>Remove Tank</A><BR>
"}
	var/output_text = {"<link rel='stylesheet' href='http://178.63.153.81/ss13/ui.css' /><TT><B>[name]</B><BR>
