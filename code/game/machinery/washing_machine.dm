		...
		if(color)
			...
			for(var/T in typesof(/obj/item/clothing/shoes))
				...
				if(color == S.color)
					...
					break
				del(S)
			for(var/T in typesof(/obj/item/clothing/suit/bedsheet))
				var/obj/item/clothing/suit/bedsheet/B = new T
				//world << "DEBUG: [color] == [J.color]"
				if(color == B.color)
			...
			if(new_sheet_icon_state && new_sheet_name)
				for(var/obj/item/clothing/suit/bedsheet/B in contents)
					//world << "DEBUG: YUP! FOUND IT!"
...
/obj/machinery/washing_machine/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	/*else if(istype(W,/obj/item/weapon/grab))
		if( (state == 1) && hacked)
			...
			if(ishuman(G.assailant) && ismonkey(G.affecting))
				G.affecting.loc = src
				del(G)
				state = 3
		else
			..()*/
	else if(istype(W,/obj/item/clothing/under) || istype(W,/obj/item/clothing/mask) || istype(W,/obj/item/clothing/head) || istype(W,/obj/item/clothing/gloves) || istype(W,/obj/item/clothing/shoes) || istype(W,/obj/item/clothing/suit) || istype(W,/obj/item/clothing/suit/bedsheet))
