...
datum/computer/file/embedded_program/airlock_controller/virology
	id_tag
	exterior_door_tag
	interior_door_tag
	airpump_tag
				...
				if(AIRLOCK_STATE_CLOSED)
					...
					if(target_state > state)
						...
						if(memory["exterior_status"] == "closed")
							...
							signal.data["command"] = "secure_close"
							post_signal(signal)
					else if (sensor_pressure > target_pressure)
...
obj/machinery/embedded_controller/radio/airlock_controller/virology
	...
	initialize()
		...
		var/datum/computer/file/embedded_program/airlock_controller/virology/new_prog = new
