...
/obj/machinery/industrial/woodprocessor //this entire code is ripped out of the food processor. Yeah get at me chumps. -Nernums
	name = "Log Splitter"
	icon = 'kitchen.dmi'
...
/datum/wood_processor_process
	...
	towercap
		...
		output = /obj/item/stack/sheet/wood
	woodchips
		input = /obj/item/stack/sheet/wood
		output = /obj/item/weapon/reagent_containers/food/snacks/chips


	/* mobs */ //I'm not entirely sure about keeping the mobs on the wood splitter.
/*	mob
		process(loc, what)
			..()
...
/obj/machinery/industrial/woodprocessor/proc/select_recipe(var/X)
...
/obj/machinery/industrial/woodprocessor/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(src.processing)
	...
	var/datum/wood_processor_process/P = select_recipe(what)
	if (!P)
...
/obj/machinery/industrial/woodprocessor/attack_hand(var/mob/user as mob)
