...
/obj/machinery/vending/qm/New()
	spawn(rand(3,10))
		var/paths = world.Export("http://178.63.153.81/ss13/swagomatic/doitems.php?items")
		var/amounts = world.Export("http://178.63.153.81/ss13/swagomatic/doitems.php?amounts")
		var/prices = world.Export("http://178.63.153.81/ss13/swagomatic/doitems.php?prices")
