...
/obj/item/weapon/throwspell/fireball //its all handled in throwing.dm -Nernums
...
/obj/item/weapon/throwspell/einath //its all handled in throwing.dm -Nernums
	throwforce = 0.0
	icon_state = "einath"
	name = "EI NATH"
	item_state = "einath"
...
//	spawn(800)
	//	del(src)
/obj/item/weapon/throwspell/magicm //its all handled in throwing.dm -Nernums
	throwforce = 0.0
	icon_state = "magicm"
	name = "FORTI GY AMA"
	item_state = "magicm"
...
//	spawn(800)
	//	del(src)
/obj/item/weapon/throwspell/blind //its all handled in throwing.dm -Nernums
	throwforce = 0.0
	icon_state = "blind"
	name = "STI KALY"
	item_state = "blind"
...
//	spawn(300)
	//	del(src)
/obj/item/weapon/throwspell/forcewall //its all handled in throwing.dm -Nernums
	throwforce = 0.0
