...
// ************************************************************
// Hydro-related stuff dumped here so we don't have >9001 files
// ************************************************************
...
/obj/item/weapon/satchel/hydro
	...
	maxitems = 50
	allowed = list(/obj/item/seeds/,/obj/item/weapon/reagent_containers/food/)
...
/obj/item/seeds/apricotseeds
	name = "Apricot seeds"
	desc = "Seeds that grows into apricots."
	icon_state = "seed-banana"
	mypath = "/obj/item/seeds/apricotseeds"
	species = "apricot"
	plantname = "Apricot trees"
	productname = "/obj/item/weapon/reagent_containers/food/snacks/grown/apricot"
	lifespan = 30
	endurance = 30
	maturation = 5
	production = 5
...
/obj/item/seeds/cannabisseed
	...
	productname = "/obj/item/weapon/reagent_containers/food/snacks/grown/cannabisleaf"
	lifespan = 30
...
/obj/item/seeds/tobacco
	...
	mypath = "/obj/item/seeds/tobacco"
	species = "tobacco"
	plantname = "nicotiana plant"
	productname = "/obj/item/weapon/reagent_containers/food/snacks/grown/tobaccoleaf"
	lifespan = 40
	endurance = 35 // tuff like a toiger
	maturation = 6
	production = 9
	yield = 4
	potency = 8
...
/obj/item/weapon/reagent_containers/food/snacks/grown/potato
	...
	New()
		..()
		reagents.add_reagent("potato", max(round((potency / 2), 1), 2))
...
/obj/item/weapon/reagent_containers/food/snacks/grown/apricot
	...
	New()
		..()
		reagents.add_reagent("nutriment", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("apricotjuice", max(round(potency / 5, 1), rand(10,20)))
...
/obj/item/weapon/reagent_containers/food/snacks/grown/glowberries
	...
	New()
		..()
		reagents.add_reagent("nutriment", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("radium", max(round(potency / 5, 1), rand(10,20)))
		bitesize = max(round(reagents.total_volume / 2, 1), 1)

/obj/item/weapon/reagent_containers/food/snacks/grown/glowberries/Del()
	if(istype(loc,/mob))
		loc.ul_SetLuminosity(loc.luminosity - potency/5)
	..()

/obj/item/weapon/reagent_containers/food/snacks/grown/glowberries/pickup(mob/user)
	src.ul_SetLuminosity(0)
	user.ul_SetLuminosity(user.luminosity + potency/5)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/cocoapod
	...
	New()
		..()
		reagents.add_reagent("nutriment", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("coco", max(round(potency / 5, 1), rand(10,20)))
		bitesize = max(round(reagents.total_volume / 2, 1), 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/sugarcane
	...
	New()
		..()
		reagents.add_reagent("sugar", max(round(potency / 5, 1), rand(10,20)))
...
/obj/item/weapon/reagent_containers/food/snacks/grown/poisonberries
	...
	New()
		..()
		reagents.add_reagent("nutriment", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("toxin", max(round(potency / 5, 1), rand(10,20)))
		bitesize = max(round(reagents.total_volume / 2, 1), 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/ambrosiavulgaris
	...
	New()
		..()
		reagents.add_reagent("nutriment", 1)
		reagents.add_reagent("space_drugs", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("kelotane", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("bicaridine", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("toxin", max(round(potency / 5, 1), rand(10,20)))
		bitesize = max(round(reagents.total_volume / 2, 1), 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/banana
	...
	New()
		..()
		reagents.add_reagent("banana", max(round(potency / 5, 1), rand(10,20)))
		bitesize = 5
		src.pixel_x = rand(-5.0, 5)
		src.pixel_y = rand(-5.0, 5)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/cannabisleaf
...
/obj/item/weapon/reagent_containers/food/snacks/grown/tobaccoleaf
	...
	name = "Tobacco Leaf"
	desc = "Contains nasty addictive stuff, like nicotine."
	icon_state = "tobaccoleaf"
	New()
		..()
		reagents.add_reagent("nicotine", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("tobacco", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("nutriment", 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/bluetomato
	...
	New()
		..()
		reagents.add_reagent("nutriment", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("lube", max(round(potency / 5, 1), rand(10,20)))
		bitesize = max(round(reagents.total_volume / 2, 1), 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/icepepper
	...
	New()
		..()
		reagents.add_reagent("nutriment", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("frostoil", max(round(potency / 5, 1), rand(10,20)))
		bitesize = max(round(reagents.total_volume / 2, 1), 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/carrot
	...
	New()
		..()
		reagents.add_reagent("nutriment", max(round(potency / 5, 1), rand(10,20)))
		reagents.add_reagent("imidazoline", max(round(potency / 5, 1), rand(10,20)))
		bitesize = max(round(reagents.total_volume / 2, 1), 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/glowshroom/Del()
	if(istype(loc,/mob))
		loc.ul_SetLuminosity(loc.luminosity - potency/10)
	..()

/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/glowshroom/pickup(mob/user)
	src.ul_SetLuminosity(0)
	user.ul_SetLuminosity(user.luminosity + potency/10)
...
/obj/item/weapon/grown/log
	...
	attackby(obj/item/weapon/W as obj, mob/user as mob)
		if(istype(W, /obj/item/weapon/circular_saw) || istype(W, /obj/item/weapon/fireaxe) || istype(W, /obj/item/weapon/fireaxe/regular))
