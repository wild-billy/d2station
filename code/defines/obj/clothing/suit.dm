...
/obj/item/clothing/suit/det_suit
	...
	allowed = list(/obj/item/weapon/gun/projectile/detective,/obj/item/weapon/gun/projectile,/obj/item/ammo_magazine,/obj/item/ammo_casing,/obj/item/weapon/storage/cigpack,/obj/item/weapon/zippo,/obj/item/device/detective_scanner,/obj/item/device/taperecorder)
...
/obj/item/clothing/suit/trenchcoat
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	allowed = list(/obj/item/weapon/storage/cigpack,/obj/item/weapon/zippo)
	armor = list(melee = 20, bullet = 10, laser = 10, taser = 40, bomb = 20, bio = 5, rad = 0)
...
/obj/item/clothing/suit/judgerobe
	...
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	allowed = list(/obj/item/weapon/storage/cigpack,/obj/item/weapon/money)
...
/obj/item/clothing/suit/labcoat/hoodie
	name = "xXBloodyTearsXx Brand Red Hoodie"
	desc = "a red hoodie (toggle for hood)"
	icon_state = "hoodie_open"
	item_state = "hoodie"
	armor = list(melee = 0, bullet = 0, laser = 2, taser = 2, bomb = 0, bio = 55, rad = 5)
...
/obj/item/clothing/suit/wizrobe
	...
	armor = list(melee = 30, bullet = 20, laser = 20, taser = 55, bomb = 20, bio = 20, rad = 20)
...
/obj/item/clothing/suit/armor/swat/deathcommando
...
/obj/item/clothing/suit/armor/riotlight
	name = "riot armor"
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	armor = list(melee = 60, bullet = 25, laser = 22, taser = 22, bomb = 5, bio = 0, rad = 0)
...
/obj/item/clothing/suit/fire/heavy
	...
	desc = "A specialized firesuit equipped with an internal cooling system. Can protect the user from more than four times the amount of heat than can a standard firesuit."
	icon_state = "thermal"
	item_state = "thermal"
	//w_class = 4//bulky item
...
/obj/item/clothing/suit/space/rig
	name = "rig suit"
	desc = "A special suit that protects against hazardous, low pressure environments. Has radiation and heat shielding."
	icon_state = "rig"
	item_state = "rig_suit"
...
/obj/item/clothing/suit/space/emergency
	name = "emergency pressure suit"
	icon_state = "emergencysuit"
	item_state = "emergencysuit"
	desc = "A disposable suit for short-term use in low-pressure environments."
...
/obj/item/clothing/suit/bedsheet/screwballcape
	name = "bedsheet"
	desc = "A simple device, used to provide flight to the user. Also can be used to make screwball fortress of solitude."
	icon = 'suits.dmi'
	icon_state = "screwballcape"
	item_state = "screwballcape"
	layer = 5
	armor = list(melee = 80, bullet = 60, laser = 50, taser = 25, bomb = 50, bio = 10, rad = 0)
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS

/obj/item/clothing/suit/bedsheet/desertpunkcape
	name = "bedsheet"
	desc = "And the raincoat blowing in the wind"
	icon = 'suits.dmi'
	icon_state = "desertpunkcape"
	item_state = "desertpunkcape"
	layer = 5
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
