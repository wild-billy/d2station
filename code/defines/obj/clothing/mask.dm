...
/obj/item/clothing/mask/antiacid
	name = "Acidproof Mask"
	desc = "A typical mask sprayed with acid repellant. Robustmistry! SCIENCE!"
	icon_state = "sterile"
	item_state = "sterile"

/obj/item/clothing/mask/antiacid/gas
...
/obj/item/clothing/mask/antiacid/sterile
	icon_state = "sterile"
	item_state = "sterile"
	w_class = 1
	flags = FPRINT|TABLEPASS|HEADSPACE|MASKCOVERSMOUTH
	gas_transfer_coefficient = 0.90
	permeability_coefficient = 0.05
	armor = list(melee = 0, bullet = 0, laser = 0, taser = 0, bomb = 0, bio = 45, rad = 0)

/obj/item/clothing/mask/antiacid/medical
	icon_state = "medical"
	item_state = "medical"
	flags = FPRINT|TABLEPASS|SUITSPACE|HEADSPACE|MASKCOVERSMOUTH
	w_class = 3
...
/obj/item/clothing/mask/antiacid/breath
	icon_state = "breath"
	item_state = "breath"
	flags = FPRINT | TABLEPASS | SUITSPACE | HEADSPACE | MASKCOVERSMOUTH
	w_class = 2
