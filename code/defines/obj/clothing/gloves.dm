...
/obj/item/clothing/gloves/apricotgloves // these really don't do anything, i'm just looking for a gimmick like fireice
	name = "Robust Gloves"
	desc = "Adds +17"
	icon_state = "apricot"
	item_state = "apricot"
	canremove = 0 // THERE IS NO ESCAPE (this also removes my ability to use insulated gloves, and it is a personal nerf.) -- snipe
